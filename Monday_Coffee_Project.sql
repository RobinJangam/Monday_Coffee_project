...
ct.avg_sale_per_cus,
ROUND 
(cr.estimated_rent:: numeric/ct.total_cus:: numeric, 2) 
as avg_rent_per_cus
...
-- Q.9 Sales growth rate: Calculate the percentage growth (or decline) in sales over different time periods (monthly).
...
LAG(total_sale, 1) OVER(PARTITION BY city_name 
